...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/decaylanguage-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10857&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/decaylanguage-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `decaylanguage` can be installed with:

```
conda install decaylanguage
```

It is possible to list all of the versions of `decaylanguage` available on your platform with:
